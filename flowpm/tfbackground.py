...
def rk4_integration(dydt, a, y0, **kwcosmo):
  ...
  i = 0
  i, yl, y = tf.while_loop(
      cond, body, [i, y0, y], swap_memory=False, maximum_iterations=steps)
  return y.stack()
...
def odesolve_func(a,  **kwcosmo):
  ...
  results = rk4_integration(
      growth_ode, a, y0,
      **kwcosmo)[:, 0]  #retruned with an extra dimension due to stacking
